...
public class EnergizedHellTeleporter extends Teleporter
{
    ...
    public EnergizedHellTeleporter(WorldServer par1WorldServer)
    {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(k1, i2, l1) == Repo.energizedHellPortal)
                        {
                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == Repo.energizedHellPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == Repo.energizedHellPortal)
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == Repo.energizedHellPortal)
            {
                j2 = 3;
            }
        ...
        for (k2 = 0; k2 < 4; ++k2)
        {
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? Blocks.sandstone : Repo.energizedHellPortal, 0, 2);
                }
            }
